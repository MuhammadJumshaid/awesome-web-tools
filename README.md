...
- [Naratake WiFi QR Code Generator](https://naratake.com/en/tools/wifi-qr-code-generator) - Generate a scannable WiFi QR code; the password stays in the browser.
